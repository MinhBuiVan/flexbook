        ...
        <div className="container-fluid">
            <div className="row align-items-center">
                ...
                <div className="col d-flex align-items-center">
                    {/* <!-- logo --> */}
                    <i className="fab fa-facebook text-primary" style="font-size: 3rem"></i>
                    {/* <!-- search bar --> */}
                ...
                <div className="col d-flex align-items-center justify-content-end">
                    {/* <!-- avatar --> */}
                    <div
                        className="align-items-center justify-content-center d-none d-xl-flex"
                    >
                        <img
                  ...
                  "
                    ...
                    >
                        ...
                        >
                            <i
                                className="fas fa-exclamation-circle bg-gray p-2 rounded-circle"
                            ></i>
                            <div className="ms-3">
    ...
    >
        ...
        >
            <div className="modal-content border-0">
                ...
                {/* <!-- footer --> */}
                <div className="modal-footer border-0" style="min-height: 300px"></div>
            </div>
        </div>
    </div>
    {/* <!-- ================= Chat Modal Mobile ================= --> */}
    ...
    >
        ...
        >
            <div className="modal-content border-0 shadow">
                  ...
                  '
                    ...
                    >
                      ...
                      <span className="visually-hidden">New alerts</span>
                        ...
                        {/* <!-- name --> */}
                        <div>
                            <p className="m-0">Mike <i className="fas fa-angle-down"></i></p>
                ...
                {/* <!-- body --> */}
                <div className="modal-body p-0 overflow-auto" style="max-height: 300px">
                    {/* <!-- message l --> */}
                ...
                <div className="modal-footer p-0 m-0 border-0">
                    <div className="d-flex">
                        <div className="d-flex align-items-center">
                            <i className="fas fa-plus-circle mx-1 fs-5 text-muted pointer"></i>
                            <i className="far fa-file-image mx-1 fs-5 text-muted pointer"></i>
                            <i className="fas fa-portrait mx-1 fs-5 text-muted pointer"></i>
                            <i className="fas fa-adjust mx-1 fs-5 text-muted pointer"></i>
                        </div>
                        <div>
                            <input
                                type="text"
                        ...
                        <div className="d-flex align-items-center mx-2">
                            <i className="fas fa-thumbs-up fs-5 text-muted pointer"></i>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div className="modal-header">
                    ...
                    >
                      ...
                      <span className="visually-hidden">New alerts</span>
                        ...
                        {/* <!-- name --> */}
                        <div>
                            <p className="m-0">Tuan <i className="fas fa-angle-down"></i></p>
                            <span className="text-muted fs-7">Active Now</span>
                        </div>
                    </div>
                    {/* <!-- close --> */}
                ...
                <div className="modal-header">
                    ...
                    >
                      ...
                      <span className="visually-hidden">New alerts</span>
                        ...
                        {/* <!-- name --> */}
                        <div>
                            <p className="m-0">Jerry <i className="fas fa-angle-down"></i></p>
                            <span className="text-muted fs-7">Active Now</span>
                        </div>
                    </div>
                    {/* <!-- close --> */}
                ...
                <div className="modal-header">
                    ...
                    >
                      ...
                      <span className="visually-hidden">New alerts</span>
                        ...
                        {/* <!-- name --> */}
                        <div>
                            <p className="m-0">Tony <i className="fas fa-angle-down"></i></p>
                            <span className="text-muted fs-7">Active Now</span>
                        </div>
                    </div>
                    {/* <!-- close --> */}
                ...
                <div className="modal-header">
                    ...
                    >
                      ...
                      <span className="visually-hidden">New alerts</span>
                        ...
                        {/* <!-- name --> */}
                        <div>
                            <p className="m-0">Phu <i className="fas fa-angle-down"></i></p>
                            <span className="text-muted fs-7">Active Now</span>
                        </div>
                    </div>
                    {/* <!-- close --> */}
                                    ...
                                    <div className="modal-content">
                                        ...
                                        <div className="modal-body">
                                            <p className="text-muted">
                                                ...
                                                you can pin something so it is always shown at the top
                    ...
                    >
                        ...
                        <div>
                            <button className="btn rounded-pill btn-info">
                                <i className="fas fa-video me-3"></i>Create Room
                            </button>
                        </div>
                        {/* <!-- slider mobile --> */}
                        ...
                        {/* <!-- slider desktop --> */}
                        <div className="d-none d-xxl-block" style="max-width: 450px">
                            <div
                      ...
                      "
                        ...
                        >
                            ...
                            <div
                                ...
                                data-bs-custom-className="chat-box"
                                data-bs-container="body"
                                data-bs-toggle="popover"
                                data-bs-placement="left"
